    ...
    describe('Route Config', function () {
      describe('Main Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(mainstate.templateUrl).toBe('/app/chat/client/views/chat.client.view.html');
        });
      });
      ...
      describe('Handle Trailing Slash', function () {
        beforeEach(inject(function ($state, $rootScope, _$httpBackend_, _Authentication_) {
          ...
          $httpBackend.whenGET('/app/chat/client/views/chat.client.view.html').respond(200);
        ...
        it('Should remove trailing slash', inject(function ($state, $location, $rootScope, $templateCache) {
          $templateCache.put('/app/chat/client/views/chat.client.view.html', '');

          $location.path('chat/');
          $rootScope.$digest();

          expect($location.path()).toBe('/chat');
          expect($state.current.templateUrl).toBe('/app/chat/client/views/chat.client.view.html');
        }));
      });
