    ...
    describe('Route Config', function () {
      ...
      describe('List Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(liststate.templateUrl).toBe('/app/articles/client/views/admin/list-articles.client.view.html');
        });
      });
      ...
      describe('Create Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          ...
          $templateCache.put('/app/articles/client/views/admin/form-article.client.view.html', '');
        ...
        it('Should have templateUrl', function () {
          expect(createstate.templateUrl).toBe('/app/articles/client/views/admin/form-article.client.view.html');
        });
      });
      ...
      describe('Edit Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(editstate.templateUrl).toBe('/app/articles/client/views/admin/form-article.client.view.html');
        });
