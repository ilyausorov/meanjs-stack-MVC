    ...
    describe('Route Config', function () {
      ...
      describe('List Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(liststate.templateUrl).toBe('/app/articles/client/views/list-articles.client.view.html');
        });
      });
      ...
      describe('View Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          ...
          $templateCache.put('/app/articles/client/views/view-article.client.view.html', '');
        ...
        it('Should have templateUrl', function () {
          expect(viewstate.templateUrl).toBe('/app/articles/client/views/view-article.client.view.html');
        });
      });

      describe('Handle Trailing Slash', function () {
        beforeEach(inject(function ($state, $rootScope, $templateCache) {
          $templateCache.put('/app/articles/client/views/list-articles.client.view.html', '');
        ...
        it('Should remove trailing slash', inject(function ($state, $location, $rootScope) {
          ...
          expect($state.current.templateUrl).toBe('/app/articles/client/views/list-articles.client.view.html');
        }));
      });
    });
  });
