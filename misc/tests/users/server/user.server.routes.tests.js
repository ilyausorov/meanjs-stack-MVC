...
var semver = require('semver'),
  ...
  express = require(path.resolve('./settings/common_files/express'));
  ...
  it('should be able to change profile picture if signed in', function (done) {
    agent.post('/api/auth/signin')
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/users/picture')
          .attach('newProfilePicture', './public/images/profile/default.png')
          .expect(200)
          .end(function (userInfoErr, userInfoRes) {
  ...
  it('should not be able to change profile picture if attach a picture with a different field name', function (done) {
    agent.post('/api/auth/signin')
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/users/picture')
          .attach('fieldThatDoesntWork', './public/images/profile/default.png')
          .send(credentials)
          .expect(422)
          .end(function (userInfoErr, userInfoRes) {
            done(userInfoErr);
  ...
  it('should not be able to upload a non-image file as a profile picture', function (done) {
    agent.post('/api/auth/signin')
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/users/picture')
          .attach('newProfilePicture', './app/users/tests/server/img/text-file.txt')
          .send(credentials)
          .expect(422)
          .end(function (userInfoErr, userInfoRes) {
            done(userInfoErr);
  ...
  it('should not be able to change profile picture to too big of a file', function (done) {
    agent.post('/api/auth/signin')
      ...
      .end(function (signinErr) {
        ...
        agent.post('/api/users/picture')
          .attach('newProfilePicture', './app/users/tests/server/img/too-big-file.png')
          .send(credentials)
          .expect(422)
          .end(function (userInfoErr, userInfoRes) {
            done(userInfoErr);
