  ...
  describe('Users Route Tests', function () {
    ...
    describe('Settings Route Config', function () {
      describe('Main Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(mainstate.templateUrl).toBe('/app/views/views_html/settings/settings.client.view.html');
        });
      });
      ...
      describe('Profile Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(profilestate.templateUrl).toBe('/app/views/views_html/settings/edit-profile.client.view.html');
        });
      });
      ...
      describe('Password Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(passwordstate.templateUrl).toBe('/app/views/views_html/settings/change-password.client.view.html');
        });
      });
      ...
      describe('Accounts Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(accountsstate.templateUrl).toBe('/app/views/views_html/settings/manage-social-accounts.client.view.html');
        });
      });
      ...
      describe('Picture Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(picturestate.templateUrl).toBe('/app/views/views_html/settings/change-profile-picture.client.view.html');
        });
      });
      ...
      describe('Handle Trailing Slash', function () {
        beforeEach(inject(function ($state, $rootScope, _Authentication_, _$httpBackend_) {
          ...
          $httpBackend.whenGET('/app/views/views_html/settings/settings.client.view.html').respond(200);
          $httpBackend.whenGET('/app/core/client/views/home.client.view.html').respond(200);
          $httpBackend.whenGET('/app/views/views_html/settings/edit-profile.client.view.html').respond(200);
        ...
        it('Should remove trailing slash', inject(function ($state, $location, $rootScope, $templateCache) {
          $templateCache.put('/app/views/views_html/settings/settings.client.view.html', '');
          $templateCache.put('/app/views/views_html/settings/edit-profile.client.view.html', '');

          $location.path('settings/profile/');
          $rootScope.$digest();

          expect($location.path()).toBe('/settings/profile');
          expect($state.current.templateUrl).toBe('/app/views/views_html/settings/edit-profile.client.view.html');
        }));
      });
    ...
    describe('Authentication Route Config', function () {
      describe('Main Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(mainstate.templateUrl).toBe('/app/views/views_html/authentication/authentication.client.view.html');
        });
      });
      ...
      describe('Signup Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(signupstate.templateUrl).toBe('/app/views/views_html/authentication/signup.client.view.html');
        });
      });
      ...
      describe('Signin Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(signinstate.templateUrl).toBe('/app/views/views_html/authentication/signin.client.view.html');
        });
      });
    ...
    describe('Password Route Config', function () {
      ...
      describe('Forgot Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(forgotstate.templateUrl).toBe('/app/views/views_html/password/forgot-password.client.view.html');
        });
      });
    ...
    describe('Password Reset Route Config', function () {
      ...
      describe('Invalid Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(invalidstate.templateUrl).toBe('/app/views/views_html/password/reset-password-invalid.client.view.html');
        });
      });
      ...
      describe('Success Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(successstate.templateUrl).toBe('/app/views/views_html/password/reset-password-success.client.view.html');
        });
      });
      ...
      describe('Form Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(formstate.templateUrl).toBe('/app/views/views_html/password/reset-password.client.view.html');
        });
      });
