...
var _ = require('lodash'),
  ...
  logger = require(path.resolve('./settings/common_files/logger')),
  seed = require(path.resolve('./settings/common_files/mongo-seed')),
...
describe('Configuration Tests:', function () {
  ...
  describe('Testing Logger Configuration', function () {
    ...
    it('should use the default log format of "combined" when an invalid format was provided', function () {
      ...
      var _logger = require(path.resolve('./settings/common_files/logger'));
