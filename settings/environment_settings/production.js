  ...
  db: {
    ...
    options: {
      ...
      * for connect to a replicaset, rename server:{...} to replset:{...}
      ...
      sslCA: fs.readFileSync('./settings/sslcerts/ssl-ca.pem'),
      sslCert: fs.readFileSync('./settings/sslcerts/ssl-cert.pem'),
      sslKey: fs.readFileSync('./settings/sslcerts/ssl-key.pem'),
      sslPass: '1234'
